###############################################################################################################
# Title: PCO plot MaxN per hour for fish community (Trophic level < 3.75)
...
#Saving PCO for biomass - method and management status
ggsave("Figures/PCO_FishCom.tiff",
       Plot3_4, device = "tiff", dpi = 300, width = 21, height = 10)


# Data from Fish Community ------------------------------------------------

PCO_FishCom <- PCO_MaxNFish

Mat_FishCom <- MaxN_mat

Dist_FishCom <- MaxN_mat_dist
